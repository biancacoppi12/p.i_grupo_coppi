<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarOPAbertaOperador.aspx.cs" Inherits="Paginas_OrdemProducao_ListarOPAberta" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="active treeview-menu">
                                <li><a href="<%= Page.ResolveUrl("../OrdemProducao/ListarOPAbertaOperador.aspx") %>"><i class="fa fa-book"></i>Ordem de Produção</a></li>
                            </ul>
                        </li>
            ...
            <SortedDescendingHeaderStyle BackColor="#275353" />
                    ...
                    <asp:HyperLink ID="hlFechada" CssClass="btn btn-info" runat="server" NavigateUrl="~/Paginas/OrdemProducao/ListarOPFechadaOperador.aspx">Lista de OP Fechada</asp:HyperLink>
                    <br />
