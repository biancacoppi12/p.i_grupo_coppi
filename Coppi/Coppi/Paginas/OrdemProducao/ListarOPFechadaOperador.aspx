<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarOPFechadaOperador.aspx.cs" Inherits="Paginas_OrdemProducao_ListarOPFechada" %>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                  <li><a href="<%= Page.ResolveUrl("ListarOPAbertaOperador.aspx") %>"><i class="fa fa-book"></i>Ordem de Produção</a></li>
                            </ul>
                        </li>
    ...
    <div>
        ...
        <asp:GridView ID="grvOPAberta" runat="server" CssClass="tabela" AutoGenerateColumns="False" Width="90%" CellPadding="4" GridLines="Vertical" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="13px" HorizontalAlign="Center">
            <Columns>
                ...
                <asp:BoundField DataField="tap_valorVenda" HeaderText="Valor Total" DataFormatString="{0:c}" />
