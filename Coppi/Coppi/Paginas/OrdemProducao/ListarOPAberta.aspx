<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarOPAberta.aspx.cs" Inherits="Paginas_OrdemProducao_ListarOPAberta" %>
        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<%= Page.ResolveUrl("../OrdemProducao/ListarOPAberta.aspx") %>"><i class="fa fa-book"></i>Ordem de Produção</a></li>
                            </ul>
                        </li>
            ...
            <div class="content-wrapper">
                ...
                <div>
                    ...
                    <br />
                    <asp:GridView ID="grvOPAberta" OnRowCommand="grvOPAberta_RowCommand" runat="server" CssClass="tabela" AutoGenerateColumns="False" Width="90%" CellPadding="4" GridLines="Vertical" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="13px" HorizontalAlign="Center">
                        <Columns>
                            <asp:BoundField DataField="pes_nomeFantasia" HeaderText="Cliente" />
                            <asp:BoundField DataField="ord_dataEntrada" HeaderText="Data de Entrada" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="ord_previsaoEntrega" HeaderText="Previsão de Entrega" DataFormatString="{0:dd/MM/yyyy}" />
                           <%-- <asp:BoundField DataField="tap_largura" HeaderText="Largura" />
                            <asp:BoundField DataField="tap_comprimento" HeaderText="Comprimento" />--%>
                            <asp:BoundField DataField="tap_tipoArte" HeaderText="Tipo de Arte" />
                            <asp:BoundField DataField="sta_descricao" HeaderText="Status" />

          <asp:TemplateField>
               <ItemTemplate> 
              <asp:LinkButton ID="lbAlterar" runat="server" CommandName="Alterar" CommandArgument='<%# Bind("ord_id")%>'>Alterar</asp:LinkButton>
            ...
            <SortedDescendingHeaderStyle BackColor="#275353" />
                    ...
                    <br />
                    <br />
                    <asp:HyperLink ID="hlAguardando" CssClass="btn btn-info" runat="server" NavigateUrl="~/Paginas/OrdemProducao/ListarAguardando.aspx">Lista de OP Aguardando Vulcanização</asp:HyperLink>
