<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Paginas_MateriaPrima_Listar" %>
...
<body class="skin-green">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                             <li><a href="<%= Page.ResolveUrl("../Cliente/Listar.aspx") %>"><i class="fa fa-user-circle"></i>Cliente </a></li>
                                ...
                                <li class="active"><a href="<%= Page.ResolveUrl("../MateriaPrima/Listar.aspx") %>"><i class="fa fa-cogs"></i>Matéria-Prima</a></li>
    ...
    <div>
        ...
        <br />
        <asp:GridView ID="grvMateria" runat="server" CssClass="tabela" OnRowCommand="grvMateria_RowCommand" AutoGenerateColumns="False" Width="90%" CellPadding="4" GridLines="Vertical" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="13px" HorizontalAlign="Center">
            <Columns>
                <asp:BoundField DataField="map_nome" HeaderText="Nome" />
                 <asp:BoundField DataField="map_quantidadeTotal" HeaderText="Quantidade (m2)" />
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lbAlterar" runat="server" CommandName="Alterar"
                            CommandArgument='<%# Bind("map_id")%>'>Alterar</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
