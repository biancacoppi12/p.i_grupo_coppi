<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadastrar.aspx.cs" Inherits="Paginas_MateriaPrima_Cadastrar" %>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<%= Page.ResolveUrl("../MateriaPrima/Cadastrar.aspx") %>"><i class="fa fa-cogs"></i>Matéria-Prima</a></li>
    ...
    <div class="container">
        ...
        <div class="main-login main-center">
            ...
            <div id="tituloPagina" class="col-lg-12">
                <asp:Label ID="lblTitulo" CssClass="titulo" runat="server" Text="Cadastro de Matéria-Prima"></asp:Label>
            </div>
            <br />
            ...
            <div class="form-group">
                ...
                <div class="cols-sm-10">
                    <div class="input-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvNome" ControlToValidate="txtNome" SetFocusOnError="true" Text="<b>*</b>" runat="server" ErrorMessage="Preencha o nome da matéria prima"></asp:RequiredFieldValidator>
                        <br />
                        <br />
        ...
        <asp:Button ID="btn_Salvar" CssClass="btn btn-success" runat="server" Text="Salvar" OnClick="btnSalvar_Click" />
        ...
        <asp:HyperLink ID="hlVincular" CssClass="btn btn-info" runat="server" NavigateUrl="~/Paginas/MateriaPrima/Vincular.aspx">Relacao Matéria Prima com Fornecedor</asp:HyperLink>
