<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vincular.aspx.cs" Inherits="Paginas_MateriaPrima_Vincular" %>
                            ...
                            <ul class="treeview-menu">
                             <li class="active"><a href="<%= Page.ResolveUrl("../Cliente/Listar.aspx") %>"><i class="fa fa-user-circle"></i>Cliente </a></li>
                                ...
                                <li><a href="<%= Page.ResolveUrl("../MateriaPrima/Listar.aspx") %>"><i class="fa fa-cogs"></i>Matéria-Prima</a></li>
                                  ...
                                  <li><a href="<%= Page.ResolveUrl("../OrdemProducao/Listar.aspx") %>"><i class="fa fa-book"></i>Ordem de Produção</a></li>
                            </ul>
                        </li>
    ...
    <div class="container">
        ...
        <div class="main-login main-center">
            ...
            <div id="tituloPagina" class="col-lg-12">
                <asp:Label ID="lblCadastro" CssClass="titulo" runat="server" Text="Selecione os Fornecedores da Matéria-Prima"></asp:Label>
            </div>
            <br />
            <div id="msgSucesso">
            ...
            <div class="form-group">
                ...
                <div class="cols-sm-10">
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="ddlMateria"  class="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlMateria_SelectedIndexChanged">
                        </asp:DropDownList>
                        <br />
                        <br />
                    </div>
        ...
        <div class="form-group">
            <asp:Label ID="lblFornecedor" class="cols-sm-2 control-label" AssociatedControlID="ddlFornecedor" runat="server" Text="Fornecedores:"></asp:Label>
            <br />
            <div class="cols-sm-10">
                <div class="input-group">

                    <asp:DropDownList ID="ddlFornecedor"  class="form-control" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                    <br />
                    <br />
                    <br />
            ...
            <br />
            <br />
            <asp:GridView ID="grvMateriaPrima" runat="server" CssClass="tabela" AutoGenerateColumns="False" HeaderStyle-BackColor="Silver" HeaderStyle-BorderColor="Black" HeaderStyle-BorderStyle="Solid" HeaderStyle-BorderWidth="1 px" Width="90%">
                <Columns>
                    <asp:BoundField DataField="map_nome" HeaderText="Nome" />
                    <asp:BoundField DataField="pes_nomeFantasia" HeaderText="Nome Fantasia do Fornecedor" />
                    <asp:BoundField DataField="pes_razaoSocial" HeaderText="Razão Social do Fornecedor" />
