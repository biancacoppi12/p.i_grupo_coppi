<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Paginas_NotaFiscal_Listar" %>
        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<%= Page.ResolveUrl("../NotaFiscal/Listar.aspx") %>"><i class="glyphicon glyphicon-duplicate"></i>Nota Fiscal</a></li>
            ...
            <div class="content-wrapper">
                ...
                <div>
                    ...
                    <br />
                    <asp:GridView ID="grvNF" OnRowCommand="grvNF_RowCommand" runat="server" CssClass="tabela" AutoGenerateColumns="False" Width="90%" CellPadding="4" GridLines="Vertical" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="13px" HorizontalAlign="Center">
                        <Columns>
                      

                            <asp:BoundField DataField="pes_razaoSocial" HeaderText="Fornecedor" />
                            <asp:BoundField DataField="nfi_numeroNotaFiscal" HeaderText="Número da Nota Fiscal" />
                            <asp:BoundField DataField="nfi_dataEmissao" HeaderText="Data de Emissão" />
                            <asp:BoundField DataField="nfi_valorTotal" HeaderText="Valor Total (R$)" />
                         
                            <%-- Não esta funcionando !!!! quando usar valor inteiro no BIND ele da erro!! --%>
                         <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbAlterar" runat="server" CommandName="Alterar"
                                       CommandArgument='<%# Bind("nfi_id")%>'>Alterar</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
