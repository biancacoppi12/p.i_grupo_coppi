<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alterar.aspx.cs" Inherits="Paginas_Fornecedor_Alterar" %>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<%= Page.ResolveUrl("../Cliente/Listar.aspx") %>"><i class="fa fa-user-circle"></i>Cliente </a></li>
                                <li class="active"><a href="<%= Page.ResolveUrl("../Fornecedor/Listar.aspx") %>"><i class="fa fa-industry"></i>Fornecedor</a></li>
            ...
            <div class="content-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="main-login main-center">
                        ...
                        <br />
                        <div id="tituloPagina">
                            <asp:Label ID="lblAlteracao" runat="server" Text="Alteração de Fornecedor"></asp:Label>
                        </div>
                        <br />
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCnpj" CssClass="CnpjMascara" class="form-control" Enabled="False" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i></span>
                                <asp:TextBox ID="txtRazao" class="form-control" Enabled="False" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i></span>
                                <asp:TextBox ID="txtInscricao" class="form-control" Enabled="False" runat="server" Width="40%"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtEmail" class="form-control" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCep" class="form-control" CssClass="CepMascara" ToolTip="Somente números" runat="server" Width="40%"></asp:TextBox>
