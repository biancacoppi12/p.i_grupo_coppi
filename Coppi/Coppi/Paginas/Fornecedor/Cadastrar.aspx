<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadastrar.aspx.cs" Inherits="Paginas_Fornecedor_Cadastrar" %>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<%= Page.ResolveUrl("../Fornecedor/Cadastrar.aspx") %>"><i class="fa fa-industry"></i>Fornecedor</a></li>
                ...
                <div class="container">
                    ...
                    <div class="main-login main-center">
                        ...
                        <div id="tituloPagina" class="col-lg-12">
                            <asp:Label ID="lblCadastro" CssClass="titulo" runat="server" Text="Cadastro de Fornecedores"></asp:Label>
                        </div>
                        <br />
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i></span>
                                <asp:TextBox ID="txtRazao"  class="form-control" runat="server" Width="40%" placeholder="Digite a Razão Social" ToolTip="Razão social da empresa"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtTelefone" CssClass="TelefoneMascara" class="form-control" ToolTip="Somente números" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCelular" CssClass="CelularMascara" class="form-control" ToolTip="Somente números" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtEmail"  class="form-control" placeholder="Email" ToolTip="Somente números" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCep" CssClass="CepMascara" class=" form-control" ToolTip="Somente números" runat="server" placeholder="Somente números" Width="40%"></asp:TextBox>
