<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Paginas_Fornecedor_Listar" %>
            ...
            <div class="content-wrapper">
                ...
                <div style="height: 286px">
                    ...
                    <div id="tituloPagina" class="col-lg-12">
                        <asp:Label ID="lblAlteracao" runat="server" CssClass="titulo" Text="Lista de Fornecedores"></asp:Label>
                    </div>
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <asp:GridView ID="grvFornecedores" runat="server" AutoGenerateColumns="False" CssClass="tabela" OnRowCommand="grvFornecedores_RowCommand" Width="90%" CellPadding="4" GridLines="Vertical" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="13px" HorizontalAlign="Center">
                        <Columns>
