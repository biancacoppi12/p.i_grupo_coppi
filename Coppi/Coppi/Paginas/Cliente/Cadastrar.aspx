<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Cadastrar.aspx.cs" Inherits="Paginas_Cliente_Cadastrar" %>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="<%= Page.ResolveUrl("../Cliente/Cadastrar.aspx") %>"><i class="fa fa-user-circle"></i>Cliente </a></li>
                ...
                <div class="container">
                    ...
                    <div class="main-login main-center">
                        ...
                        <div id="tituloPagina" class="col-lg-12">
                            <asp:Label ID="lblCadastro" runat="server" CssClass="titulo" Text="Cadastro de Clientes"></asp:Label>
                        </div>
                        <br />
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtNome"  class="form-control" placeholder="Nome da Empresa" runat="server" Width="40%"></asp:TextBox>
                                    <br />
                                    <br />
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCnpj" CssClass="CnpjMascara" class="form-control" runat="server" Width="40%" ToolTip="Somente números"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvCnpj" ControlToValidate="txtCnpj" SetFocusOnError="True" Text="<b>*</b>" runat="server" ErrorMessage="Preencha o CNPJ apenas com números"></asp:RequiredFieldValidator>
                                <br />
                                <br />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i></span>
                                <asp:TextBox ID="txtRazao"  class="form-control" placeholder="Digite a Razão Social" runat="server" Width="40%" ToolTip="Razão social da empresa"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvRazao" ControlToValidate="txtRazao" SetFocusOnError="True" Text="<b>*</b>" runat="server" ErrorMessage="Preencha a Razão Social"></asp:RequiredFieldValidator>
                                <br />
                                <br />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblInscricao" class="cols-sm-2 control-label" AssociatedControlID="txtInscricao" runat="server" Text="Inscrição Estadual:"></asp:Label>
                        <br />
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-edit" aria-hidden="true"></i></span>
                                <asp:TextBox ID="txtInscricao"  class="form-control" runat="server" Width="40%"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtData" runat="server" class="form-control" Enabled="False"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtTelefone" CssClass="TelefoneMascara" class="form-control" runat="server" Width="40%" ToolTip="Somente números"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCelular" CssClass="CelularMascara" ToolTip="Somente números" class="form-control" runat="server" Width="40%"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtCep" placeholder="Somente Números"  class="form-control" runat="server" Width="40%" ToolTip="Somente números"></asp:TextBox>
