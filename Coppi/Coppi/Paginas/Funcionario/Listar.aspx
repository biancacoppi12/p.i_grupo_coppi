<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Paginas_Funcionario_Listar" %>
...
<body class="skin-green">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                             <li><a href="<%= Page.ResolveUrl("../Cliente/Listar.aspx") %>"><i class="fa fa-user-circle"></i>Cliente </a></li>
                                ...
                                <li class="active"><a href="<%= Page.ResolveUrl("../Funcionario/Listar.aspx") %>"><i class="fa fa-id-card-o"></i>Funcionário</a></li>
    ...
    <div>
        ...
        <div id="tituloPagina" class="col-lg-12">
            <asp:Label ID="lblAlteracao" runat="server" CssClass="titulo" Text="Lista de Funcionários"></asp:Label>
        </div>
      <br />  <br />  <br />
       <div class="mensagem">
        ...
        <asp:GridView ID="grvFuncionarios" runat="server" AutoGenerateColumns="False" CssClass="tabela" OnRowCommand="grvFuncionarios_RowCommand" Width="90%" CellPadding="4" GridLines="Vertical" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="13px" HorizontalAlign="Center">
            <Columns>
